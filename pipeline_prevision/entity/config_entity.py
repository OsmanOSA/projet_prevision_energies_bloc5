...
class DataIngestionConfig:
    ...
    def __init__(self, 
        ...
        self.submission_file_path: str = os.path.join(
            self.data_ingestion_dir, 
            training_pipeline.DATA_INGESTION_INGESTED_DIR, 
            training_pipeline.SUBMISSION_FILE_NAME
        )

        self.train_test_split_ratio = training_pipeline.DATA_INGESTION_TRAIN_TEST_SPLIT_RATIO
        self.train_valid_split_ratio = training_pipeline.DATA_INGESTION_TRAIN_VALID_SPLIT_RATIO
...
class DataTransformationConfig:
    ...
    def __init__(self, 
        ...
        self.transformed_submission_file_path: str = os.path.join(
            self.data_transformation_dir,  
            training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            training_pipeline.SUBMISSION_FILE_NAME.replace("csv", "npy"))
