...
def display_page(pathname):
    ...
    nav_links = [
        create_nav_link("/dashboard/", "fas fa-home", "Accueil", pathname == "/dashboard/" or pathname == "/dashboard"),
        create_nav_link("/dashboard/overview", "fas fa-chart-line", "Vue d'ensemble", pathname == "/dashboard/overview"),
        create_nav_link("/dashboard/consumption", "fas fa-bolt", "Analyse Consommation", pathname == "/dashboard/consumption"),
        create_nav_link("/dashboard/production", "fas fa-battery-full", "Analyse Production", pathname == "/dashboard/production"),
        create_nav_link("/dashboard/prediction", "fas fa-crystal-ball", "Prévision", pathname == "/dashboard/prediction"),
    ]
